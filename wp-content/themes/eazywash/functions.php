...
require get_template_directory() . '/them-options/theme-options-init.php';

/**
 * General Functions
 */
require get_template_directory() . '/common/general-functions.php';


// Apply filter
add_filter('body_class', 'dm_body_classes');

function dm_body_classes($classes) {
    if(!is_front_page()){
		$classes[] = 'inner-page';
	}
...
function dm_pagination($pages = '', $range = 2) 
{  
 $showitems = ($range * 2) + 1;  
 global $paged;
 ...
 echo '<li class="page-item"><a class="page-link" href="'.get_pagenum_link(1).'" aria-label="First Page">&laquo;<span class="hidden-sm-down d-none d-md-inline-block"> First</span></a></li>';
 
 if($paged > 1 && $showitems < $pages) 
 echo '<li class="page-item"><a class="page-link" href="'.get_pagenum_link($paged - 1).'" aria-label="Previous Page">&lsaquo;<span class="hidden-sm-down d-none d-md-inline-block"> Previous</span></a></li>';
 ...
 echo '<li class="page-item"><a class="page-link" href="'.get_pagenum_link($paged + 1).'" aria-label="Next Page"><span class="hidden-sm-down d-none d-md-inline-block">Next </span>&rsaquo;</a></li>';  
 
 if ($paged < $pages-1 &&  $paged+$range-1 < $pages && $showitems < $pages) 
 echo '<li class="page-item"><a class="page-link" href="'.get_pagenum_link($pages).'" aria-label="Last Page"><span class="hidden-sm-down d-none d-md-inline-block">Last </span>&raquo;</a></li>';
